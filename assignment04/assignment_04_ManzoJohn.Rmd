...
## Images
Figure 1: All Cases (Log Plot) ![10-all-cases-log](Plots/10-all-cases-log_ManzoJohn.png)
...
## Add an Equation
$P(A \mid B) = \frac{P(B \mid A)\mid P(A)}{P(B)}$
...
ny_df <- covid_df[ which( covid_df$state == "Florida"), ]
florida_df <- covid_df[ which( covid_df$state == "New York"), ]
```
