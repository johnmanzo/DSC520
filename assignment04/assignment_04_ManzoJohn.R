...
setwd("~/Bellevue/Classes/DSC 520/Personal GitHub/DSC520/assignment04")

## Load the `data/r4ds/heights.csv` to
heights_df <- read.csv("~/Bellevue/Classes/DSC 520/Personal GitHub/DSC520/data/r4ds/heights.csv")
...
covid_df <- read.csv("~/Bellevue/Classes/DSC 520/Personal GitHub/DSC520/data/nytimes/covid-19-data/us-states.csv")
